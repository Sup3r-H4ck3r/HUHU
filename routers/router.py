...
#     try:
#         result = [TaxService.create_tax(**item) for item in tqdm(data)]
...
#     return TaxService.delete_tax(p_json_list_id, p_updated_by)


# @router.get("/tax/tax_code_rcd")
# async def get_tax_by_id(tax_code_rcd: str):
#     """Lấy thông tin thuế theo mã."""
#     return TaxService.get_tax_by_id(tax_code_rcd)


# @router.get("/tax/dropdown")
# async def get_tax_dropdown(lang: str):
#     """Lấy danh sách thuế dạng dropdown."""
#     return TaxService.get_tax_dropdown(lang)


# @router.get("/tax/search")
# async def search_tax(p_page_index: int, p_page_size: int, lang: str, p_tax_code_rcd: str = "", p_tax_rule_rcd: str = "", p_tax_code_ref_name: str = ""):
#     """Tìm kiếm mã thuế theo tiêu chí."""
#     return TaxService.search_tax(p_page_index, p_page_size, lang, p_tax_code_rcd, p_tax_rule_rcd, p_tax_code_ref_name)
...
#     try:
#         result = [TaxService.update_tax(**item) for item in tqdm(data)]
